...
QTGE_VERSION := 5.12.0-beta1
QTGE_URL := http://download.qt.io/development_releases/qt/5.12/$(QTGE_VERSION)/submodules/qtgraphicaleffects-everywhere-src-$(QTGE_VERSION).tar.xz
