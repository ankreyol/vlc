...
QTQC2_VERSION := 5.12.0-beta1
QTQC2_URL := http://download.qt.io/development_releases/qt/5.12/$(QTQC2_VERSION)/submodules/qtquickcontrols2-everywhere-src-$(QTQC2_VERSION).tar.xz
