...
QTSVG_VERSION := 5.12.0-beta1
QTSVG_URL := https://download.qt.io/development_releases/qt/5.12/$(QTSVG_VERSION)/submodules/qtsvg-everywhere-src-$(QTSVG_VERSION).tar.xz
